...
\definecolor{SBWgreen}{RGB}{83, 145, 128 }		% SBW green $sbw-green: #539180;
\definecolor{SBWpink}{RGB}{150, 67, 90 }		% SBW pibk:  #96435A;

\newcommand{\primarycolor}{SBWgreen}
\newcommand{\secondarycolor}{SBWpink}
...
% talk types colors
\newcommand{\IScolor}{SBWgreen} % invited speaker
\newcommand{\CTcolor}{white} % contributed talk


% row types
\newcommand{\tablebreak}[2]{% {time span}{break name}
	\rowcolor{SBWpink} #1 &  \multicolumn{3}{c|}{\bfseries #2} \\ \hline }
